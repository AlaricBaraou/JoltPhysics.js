...
declare module Jolt {
    ...
    class CylinderShapeSettings extends ConvexShapeSettings {
        constructor(inHalfHeight: number, inRadius: number, inConvexRadius?: number, inMaterial?: PhysicsMaterial);
    ...
    class TaperedCylinderShapeSettings extends ConvexShapeSettings {
        constructor(inHalfHeightOfTaperedCylinder: number, inTopRadius: number, inBottomRadius: number, inConvexRadius?: number, inMaterial?: PhysicsMaterial);
        get_mHalfHeight(): number;
        set_mHalfHeight(mHalfHeight: number): void;
        mHalfHeight: number;
    ...
    class CapsuleShapeSettings extends ConvexShapeSettings {
        constructor(inHalfHeight: number, inRadius: number, inMaterial?: PhysicsMaterial);
        get_mRadius(): number;
        set_mRadius(mRadius: number): void;
        mRadius: number;
    ...
    class TaperedCapsuleShapeSettings extends ConvexShapeSettings {
        constructor(inHalfHeightOfTaperedCylinder: number, inTopRadius: number, inBottomRadius: number, inMaterial?: PhysicsMaterial);
        get_mHalfHeightOfTaperedCylinder(): number;
        set_mHalfHeightOfTaperedCylinder(mHalfHeightOfTaperedCylinder: number): void;
    ...
    class MutableCompoundShape extends CompoundShape {
        AddShape(inPosition: Vec3, inRotation: Quat, inShape: Shape, inUserData: number, inIndex?: number): number;
    ...
    class MeshShapeSettings extends ShapeSettings {
        constructor();
        constructor(inTriangleList: TriangleList, inMaterialList?: PhysicsMaterialList);
        constructor(inVertices: VertexList, inTriangles: IndexedTriangleList, inMaterialList: PhysicsMaterialList);
        Sanitize(): void;
        ...
        set_mActiveEdgeCosThresholdAngle(mActiveEdgeCosThresholdAngle: number): void;
    ...
    class HeightFieldShape extends Shape {
        ...
        SetMaterials(inX: number, inY: number, inSizeX: number, inSizeY: number, inMaterials: Uint8MemRef, inMaterialsStride: number, inMaterialList: PhysicsMaterialList, inAllocator: TempAllocator): boolean;
    }
    class PlaneShapeSettings extends ShapeSettings {
        constructor(inPlane: Plane, inMaterial?: PhysicsMaterial, inHalfExtent?: number);
        get_mPlane(): Plane;
    ...
    class SixDOFConstraintSettings extends TwoBodyConstraintSettings {
        ...
        SetLimitedAxis(inAxis: SixDOFConstraintSettings_EAxis, inMin: number, inMax: number): void;
        get_mSpace(): EConstraintSpace;
        set_mSpace(mSpace: EConstraintSpace): void;
        mSpace: EConstraintSpace;
        get_mPosition1(): RVec3;
        ...
        set_mLimitsSpringSettings(index: number, mLimitsSpringSettings: SpringSettings): void;
        mLimitsSpringSettings: SpringSettings;
    ...
    class SixDOFConstraint extends TwoBodyConstraint {
        ...
        SetMaxFriction(inAxis: SixDOFConstraintSettings_EAxis, inFriction: number): void;
    ...
    class PathConstraintSettings extends TwoBodyConstraintSettings {
        ...
        set_mRotationConstraintType(mRotationConstraintType: EPathRotationConstraintType): void;
    ...
    class RackAndPinionConstraintSettings extends TwoBodyConstraintSettings {
        constructor();
        SetRatio(inNumTeethRack: number, inRackLength: number, inNumTeethPinion: number): void;
        get_mSpace(): EConstraintSpace;
        set_mSpace(mSpace: EConstraintSpace): void;
        mSpace: EConstraintSpace;
        get_mHingeAxis(): Vec3;
    ...
    class MotionProperties {
        ...
        MoveKinematic(inPosition: Vec3, inRotation: Quat, inDeltaTime: number): void;
    ...
    class Body {
        ...
        MoveKinematic(inPosition: RVec3, inRotation: Quat, inDeltaTime: number): void;
        ApplyBuoyancyImpulse(inSurfacePosition: RVec3, inSurfaceNormal: Vec3, inBuoyancy: number, inLinearDrag: number, inAngularDrag: number, inFluidVelocity: Vec3, inGravity: Vec3, inDeltaTime: number): boolean;
    ...
    class BodyInterface {
        ...
        UnassignBodyIDs(inBodyIDs: BodyIDMemRef, inNumber: number, outBodies: BodyPtrMemRef): void;
        ...
        AddBodiesPrepare(ioBodies: BodyIDMemRef, inNumber: number): BodyInterface_AddState;
        AddBodiesFinalize(ioBodies: BodyIDMemRef, inNumber: number, inAddState: BodyInterface_AddState, inActivationMode: EActivation): void;
        AddBodiesAbort(ioBodies: BodyIDMemRef, inNumber: number, inAddState: BodyInterface_AddState): void;
        ...
        SetShape(inBodyID: BodyID, inShape: Shape, inUpdateMassProperties: boolean, inActivationMode: EActivation): void;
        NotifyShapeChanged(inBodyID: BodyID, inPreviousCenterOfMass: Vec3, inUpdateMassProperties: boolean, inActivationMode: EActivation): void;
        ...
        MoveKinematic(inBodyID: BodyID, inPosition: RVec3, inRotation: Quat, inDeltaTime: number): void;
    ...
    class PhysicsSettings {
        ...
        set_mBodyPairCacheMaxDeltaPositionSq(mBodyPairCacheMaxDeltaPositionSq: number): void;
        mBodyPairCacheMaxDeltaPositionSq: number;
        get_mBodyPairCacheCosMaxDeltaRotationDiv2(): number;
        set_mBodyPairCacheCosMaxDeltaRotationDiv2(mBodyPairCacheCosMaxDeltaRotationDiv2: number): void;
        mBodyPairCacheCosMaxDeltaRotationDiv2: number;
        get_mContactNormalCosMaxDeltaRotation(): number;
        set_mContactNormalCosMaxDeltaRotation(mContactNormalCosMaxDeltaRotation: number): void;
        ...
        set_mPointVelocitySleepThreshold(mPointVelocitySleepThreshold: number): void;
    ...
    class ContactManifold {
        ...
        set_mRelativeContactPointsOn1(mRelativeContactPointsOn1: ContactPoints): void;
        mRelativeContactPointsOn1: ContactPoints;
        get_mRelativeContactPointsOn2(): ContactPoints;
        set_mRelativeContactPointsOn2(mRelativeContactPointsOn2: ContactPoints): void;
    ...
    class ContactSettings {
        ...
        set_mRelativeLinearSurfaceVelocity(mRelativeLinearSurfaceVelocity: Vec3): void;
        mRelativeLinearSurfaceVelocity: Vec3;
        get_mRelativeAngularSurfaceVelocity(): Vec3;
        set_mRelativeAngularSurfaceVelocity(mRelativeAngularSurfaceVelocity: Vec3): void;
    ...
    class SoftBodyContactListenerJS extends SoftBodyContactListenerEm {
        constructor();
        OnSoftBodyContactValidate(inSoftBody: number, inOtherBody: number, ioSettings: number): number;
    ...
    class BroadPhaseQuery {
        CastRay(inRay: RayCast, ioCollector: RayCastBodyCollector, inBroadPhaseFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter): void;
        CollideAABox(inBox: AABox, ioCollector: CollideShapeBodyCollector, inBroadPhaseFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter): void;
        CollideSphere(inCenter: Vec3, inRadius: number, ioCollector: CollideShapeBodyCollector, inBroadPhaseLayerFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter): void;
        CollidePoint(inPoint: Vec3, ioCollector: CollideShapeBodyCollector, inBroadPhaseFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter): void;
        CollideOrientedBox(inBox: OrientedBox, ioCollector: CollideShapeBodyCollector, inBroadPhaseFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter): void;
        CastAABox(inBox: AABoxCast, ioCollector: CastShapeBodyCollector, inBroadPhaseFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter): void;
    }
    ...
    class ShapeCastSettings extends CollideSettingsBase {
        ...
        set_mUseShrunkenShapeAndConvexRadius(mUseShrunkenShapeAndConvexRadius: boolean): void;
    ...
    class NarrowPhaseQuery {
        CastRay(inRay: RRayCast, inRayCastSettings: RayCastSettings, ioCollector: CastRayCollector, inBroadPhaseLayerFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter, inBodyFilter: BodyFilter, inShapeFilter: ShapeFilter): void;
        CollidePoint(inPoint: RVec3, ioCollector: CollidePointCollector, inBroadPhaseLayerFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter, inBodyFilter: BodyFilter, inShapeFilter: ShapeFilter): void;
        CollideShape(inShape: Shape, inShapeScale: Vec3, inCenterOfMassTransform: RMat44, inCollideShapeSettings: CollideShapeSettings, inBaseOffset: RVec3, ioCollector: CollideShapeCollector, inBroadPhaseLayerFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter, inBodyFilter: BodyFilter, inShapeFilter: ShapeFilter): void;
        CollideShapeWithInternalEdgeRemoval(inShape: Shape, inShapeScale: Vec3, inCenterOfMassTransform: RMat44, inCollideShapeSettings: CollideShapeSettings, inBaseOffset: RVec3, ioCollector: CollideShapeCollector, inBroadPhaseLayerFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter, inBodyFilter: BodyFilter, inShapeFilter: ShapeFilter): void;
        CastShape(inShapeCast: RShapeCast, inShapeCastSettings: ShapeCastSettings, inBaseOffset: RVec3, ioCollector: CastShapeCollector, inBroadPhaseLayerFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter, inBodyFilter: BodyFilter, inShapeFilter: ShapeFilter): void;
        CollectTransformedShapes(inBox: AABox, ioCollector: TransformedShapeCollector, inBroadPhaseLayerFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter, inBodyFilter: BodyFilter, inShapeFilter: ShapeFilter): void;
    }
    ...
    class PhysicsSystem {
        ...
        SaveState(inStream: StateRecorder, inState?: EStateRecorderState, inFilter?: StateRecorderFilter): void;
        RestoreState(inStream: StateRecorder, inFilter?: StateRecorderFilter): boolean;
    ...
    class BodyCreationSettings {
        constructor();
        constructor(inShape: Shape, inPosition: RVec3, inRotation: Quat, inMotionType: EMotionType, inObjectLayer: number);
        ...
        set_mCollideKinematicVsNonDynamic(mCollideKinematicVsNonDynamic: boolean): void;
        ...
        set_mOverrideMassProperties(mOverrideMassProperties: EOverrideMassProperties): void;
    ...
    class SoftBodySharedSettingsFace {
        constructor(inVertex1: number, inVertex2: number, inVertex3: number, inMaterialIndex: number);
    ...
    class SoftBodySharedSettingsDihedralBend {
        constructor(inVertex1: number, inVertex2: number, inVertex3: number, inVertex4: number, inCompliance: number);
        get_mVertex(index: number): number;
        set_mVertex(index: number, mVertex: number): void;
        mVertex: number;
        get_mCompliance(): number;
    ...
    class SoftBodySharedSettingsSkinned {
        ...
        set_mWeights(index: number, mWeights: SoftBodySharedSettingsSkinWeight): void;
    ...
    class SoftBodySharedSettings {
        ...
        AddRef(): void;
        Release(): void;
        CreateConstraints(inVertexAttributes: SoftBodySharedSettingsVertexAttributes, inVertexAttributesLength: number, inBendType?: SoftBodySharedSettings_EBendType, inAngleTolerance?: number): void;
    ...
    class SoftBodyCreationSettings {
        constructor(inSettings: SoftBodySharedSettings, inPosition: RVec3, inRotation: Quat, inObjectLayer: number);
        get_mPosition(): RVec3;
        set_mPosition(mPosition: RVec3): void;
        mPosition: RVec3;
        get_mRotation(): Quat;
    ...
    class SoftBodyMotionProperties extends MotionProperties {
        ...
        SetSkinnedMaxDistanceMultiplier(inSkinnedMaxDistanceMultiplier: number): void;
        GetLocalBounds(): AABox;
        CustomUpdate(inDeltaTime: number, ioSoftBody: Body, inSystem: PhysicsSystem): void;
        SkinVertices(inRootTransform: RMat44, inJointMatrices: Mat44MemRef, inNumJoints: number, inHardSkinAll: boolean, ioTempAllocator: TempAllocator): void;
    }
    ...
    class CharacterContactListenerJS extends CharacterContactListenerEm {
        constructor();
        OnAdjustBodyVelocity(inCharacter: number, inBody2: number, ioLinearVelocity: number, ioAngularVelocity: number): void;
        OnContactValidate(inCharacter: number, inBodyID2: number, inSubShapeID2: number): boolean;
        OnCharacterContactValidate(inCharacter: number, inOtherCharacter: number, inSubShapeID2: number): boolean;
        OnContactAdded(inCharacter: number, inBodyID2: number, inSubShapeID2: number, inContactPosition: number, inContactNormal: number, ioSettings: number): void;
        OnContactPersisted(inCharacter: number, inBodyID2: number, inSubShapeID2: number, inContactPosition: number, inContactNormal: number, ioSettings: number): void;
        OnContactRemoved(inCharacter: number, inBodyID2: number, inSubShapeID2: number): void;
        OnCharacterContactAdded(inCharacter: number, inOtherCharacter: number, inSubShapeID2: number, inContactPosition: number, inContactNormal: number, ioSettings: number): void;
        OnCharacterContactPersisted(inCharacter: number, inOtherCharacter: number, inSubShapeID2: number, inContactPosition: number, inContactNormal: number, ioSettings: number): void;
        OnCharacterContactRemoved(inCharacter: number, inOtherCharacter: number, inSubShapeID2: number): void;
        OnContactSolve(inCharacter: number, inBodyID2: number, inSubShapeID2: number, inContactPosition: number, inContactNormal: number, inContactVelocity: number, inContactMaterial: number, inCharacterVelocity: number, ioNewCharacterVelocity: number): void;
        OnCharacterContactSolve(inCharacter: number, inOtherCharacter: number, inSubShapeID2: number, inContactPosition: number, inContactNormal: number, inContactVelocity: number, inContactMaterial: number, inCharacterVelocity: number, ioNewCharacterVelocity: number): void;
    }
    ...
    class ExtendedUpdateSettings {
        ...
        set_mWalkStairsCosAngleForwardContact(mWalkStairsCosAngleForwardContact: number): void;
    ...
    class ShapeFilterJS2 extends ShapeFilter {
        constructor();
        ShouldCollide(inShape1: number, inSubShapeIDOfShape1: number, inShape2: number, inSubShapeIDOfShape2: number): boolean;
    }
    ...
    class SimShapeFilterJS extends SimShapeFilter {
        constructor();
        ShouldCollide(inBody1: number, inShape1: number, inSubShapeIDOfShape1: number, inBody2: number, inShape2: number, inSubShapeIDOfShape2: number): boolean;
    }
    class CharacterBase {
        GetRefCount(): number;
        AddRef(): void;
    ...
    class CharacterVirtual extends CharacterBase {
        constructor(inSettings: CharacterVirtualSettings, inPosition: RVec3, inRotation: Quat, inSystem: PhysicsSystem);
        GetID(): CharacterID;
        SetListener(inListener: CharacterContactListener): void;
        SetCharacterVsCharacterCollision(inCharacterVsCharacterCollision: CharacterVsCharacterCollision): void;
        ...
        Update(inDeltaTime: number, inGravity: Vec3, inBroadPhaseLayerFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter, inBodyFilter: BodyFilter, inShapeFilter: ShapeFilter, inAllocator: TempAllocator): void;
        CanWalkStairs(inLinearVelocity: Vec3): boolean;
        WalkStairs(inDeltaTime: number, inStepUp: Vec3, inStepForward: Vec3, inStepForwardTest: Vec3, inStepDownExtra: Vec3, inBroadPhaseLayerFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter, inBodyFilter: BodyFilter, inShapeFilter: ShapeFilter, inAllocator: TempAllocator): boolean;
        StickToFloor(inStepDown: Vec3, inBroadPhaseLayerFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter, inBodyFilter: BodyFilter, inShapeFilter: ShapeFilter, inAllocator: TempAllocator): boolean;
        ExtendedUpdate(inDeltaTime: number, inGravity: Vec3, inSettings: ExtendedUpdateSettings, inBroadPhaseLayerFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter, inBodyFilter: BodyFilter, inShapeFilter: ShapeFilter, inAllocator: TempAllocator): void;
        ...
        SetShape(inShape: Shape, inMaxPenetrationDepth: number, inBroadPhaseLayerFilter: BroadPhaseLayerFilter, inObjectLayerFilter: ObjectLayerFilter, inBodyFilter: BodyFilter, inShapeFilter: ShapeFilter, inAllocator: TempAllocator): boolean;
    ...
    class VehicleCollisionTesterCastSphere extends VehicleCollisionTester {
        constructor(inObjectLayer: number, inRadius: number, inUp?: Vec3, inMaxSlopeAngle?: number);
    }
    ...
    class VehicleConstraint extends Constraint {
        ...
        GetWheelLocalTransform(inWheelIndex: number, inWheelRight: Vec3, inWheelUp: Vec3): Mat44;
        GetWheelWorldTransform(inWheelIndex: number, inWheelRight: Vec3, inWheelUp: Vec3): RMat44;
    ...
    class VehicleConstraintCallbacksJS extends VehicleConstraintCallbacksEm {
        constructor();
        GetCombinedFriction(inWheelIndex: number, inTireFrictionDirection: number, inTireFriction: number, inBody2: number, inSubShapeID2: number): number;
    ...
    class WheeledVehicleControllerCallbacksJS extends WheeledVehicleControllerCallbacksEm {
        constructor();
        OnTireMaxImpulseCallback(inWheelIndex: number, outResult: number, inSuspensionImpulse: number, inLongitudinalFriction: number, inLateralFriction: number, inLongitudinalSlip: number, inLateralSlip: number, inDeltaTime: number): void;
    }
    class WheelSettings {
        constructor();
        GetRefCount(): number;
    ...
    class WheelWV extends Wheel {
        ...
        set_mCombinedLongitudinalFriction(mCombinedLongitudinalFriction: number): void;
    ...
    class WheeledVehicleControllerSettings extends VehicleControllerSettings {
        ...
        set_mDifferentialLimitedSlipRatio(mDifferentialLimitedSlipRatio: number): void;
    ...
    class TrackedVehicleController extends VehicleController {
        constructor(inSettings: TrackedVehicleControllerSettings, inConstraint: VehicleConstraint);
        SetDriverInput(inForward: number, inLeftRatio: number, inRightRatio: number, inBrake: number): void;
    ...
    class WheeledVehicleController extends VehicleController {
        constructor(inSettings: WheeledVehicleControllerSettings, inConstraint: VehicleConstraint);
        SetDriverInput(inForward: number, inRight: number, inBrake: number, inHandBrake: number): void;
        SetForwardInput(inForward: number): void;
        GetForwardInput(): number;
    ...
    class MotorcycleControllerSettings extends WheeledVehicleControllerSettings {
        ...
        set_mLeanSpringIntegrationCoefficient(mLeanSpringIntegrationCoefficient: number): void;
        mLeanSpringIntegrationCoefficient: number;
        get_mLeanSpringIntegrationCoefficientDecay(): number;
        set_mLeanSpringIntegrationCoefficientDecay(mLeanSpringIntegrationCoefficientDecay: number): void;
    ...
    class MotorcycleController extends WheeledVehicleController {
        constructor(inSettings: MotorcycleControllerSettings, inConstraint: VehicleConstraint);
        GetWheelBase(): number;
    ...
    class RagdollSettings {
        ...
        set_mAdditionalConstraints(mAdditionalConstraints: ArrayRagdollAdditionalConstraint): void;
    ...
    class BroadPhaseLayerInterfaceTable extends BroadPhaseLayerInterface {
        ...
        MapObjectToBroadPhaseLayer(inObjectLayer: number, inBroadPhaseLayer: BroadPhaseLayer): void;
    }
    class ObjectVsBroadPhaseLayerFilterTable extends ObjectVsBroadPhaseLayerFilter {
        constructor(inBroadPhaseLayerInterface: BroadPhaseLayerInterface, inNumBroadPhaseLayers: number, inObjectLayerPairFilter: ObjectLayerPairFilter, inNumObjectLayers: number);
    }
    ...
    class BroadPhaseLayerInterfaceMask extends BroadPhaseLayerInterface {
        ...
        ConfigureLayer(inBroadPhaseLayer: BroadPhaseLayer, inGroupsToInclude: number, inGroupsToExclude: number): void;
    }
    ...
    class JoltSettings {
        ...
        set_mBroadPhaseLayerInterface(mBroadPhaseLayerInterface: BroadPhaseLayerInterface): void;
        mBroadPhaseLayerInterface: BroadPhaseLayerInterface;
        get_mObjectVsBroadPhaseLayerFilter(): ObjectVsBroadPhaseLayerFilter;
        set_mObjectVsBroadPhaseLayerFilter(mObjectVsBroadPhaseLayerFilter: ObjectVsBroadPhaseLayerFilter): void;
        mObjectVsBroadPhaseLayerFilter: ObjectVsBroadPhaseLayerFilter;
        get_mObjectLayerPairFilter(): ObjectLayerPairFilter;
        set_mObjectLayerPairFilter(mObjectLayerPairFilter: ObjectLayerPairFilter): void;
